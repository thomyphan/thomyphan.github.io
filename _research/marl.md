...
To incentivize cooperative behavior in self-interested MAS, we study *decentralized mechanisms*, where agents learn to reward or penalize each other. These mechanisms are based on market theory [1] or social behavior like acknowledgments [2,3], which are well studied in other fields. We also consider real-world aspects like defectors, locality of information, noisy communication, and domain drift [2,3].

*Publications:*  
[1] [Action Markets for Emergent Cooperation](https://thomyphan.github.io/publication/2018-08-01-icann-schmid)  
[2] [Reciprocal Peer Incentivization](https://thomyphan.github.io/publication/2024-07-01-jaamas-phan)  
[3] [Reciprocal Peer Incentivization with Dynamic Rewards](https://thomyphan.github.io/publication/2026-08-03-tmlr-altmann)  
