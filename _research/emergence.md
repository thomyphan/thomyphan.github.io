...
To incentivize cooperative behavior in self-interested MAS, we study *decentralized mechanisms*, where agents learn to reward or penalize each other. These mechanisms are based on market theory [1] or social behavior like acknowledgments [2,3]. We also consider real-world aspects like defectors, locality of information, noisy communication, and domain drift [2,3].
