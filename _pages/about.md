...
My areas of interests are artificial intelligence and multi-agent systems. My current research focuses **multi-agent learning for distributed optimization** for large-scale distributed and intelligent applications such as warehouse automation, fleet management, and drone delivery. My past research focus was on **emergence and resilience in multi-agent reinforcement learning**.
